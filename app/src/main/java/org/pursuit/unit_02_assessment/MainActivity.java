    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_SEND);intent.setType("text");
     ...
     submitButton.setOnClickListener(new View.OnClickListener() {
         ...
         public void onClick(View v) {
             ...
             }else infoTextView.setText(mytext);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch(id){
            ...
            case R.id.nav_map_location:
                  intent = new Intent(Intent.ACTION_VIEW, Uri.parse("0,0?q=40.7429595,-73.94192149999998(Pursuit Android HQ)"));
                  startActivity(intent);
                  break;
